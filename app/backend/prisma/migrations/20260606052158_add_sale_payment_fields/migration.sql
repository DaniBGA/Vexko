...
INSERT INTO "new_Sale" ("clientId", "createdAt", "date", "id", "kioskId", "paymentMethod", "total", "updatedAt", "userId") SELECT "clientId", "createdAt", "date", "id", "kioskId", "paymentMethod", "total", "updatedAt", "userId" FROM "Sale";
DROP TABLE "Sale";
